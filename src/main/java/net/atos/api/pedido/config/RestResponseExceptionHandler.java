...
public class RestResponseExceptionHandler {
	...
	public ResponseEntity<String> handleHttpMessageNotReadable(HttpMessageNotReadableException exMethod,
			WebRequest request) {
	...
	public ResponseEntity<List<String>> handleConstraintViolation(ConstraintViolationException exMethod,
			WebRequest request) {
	...
	@ResponseStatus(value = HttpStatus.BAD_REQUEST)
	@ResponseBody
	public ResponseEntity<List<String>> requestHandlingNoHandlerMethodArgumentNotValidException(
			MethodArgumentNotValidException exception) {

		List<String> errors = new ArrayList<String>();
		for (ObjectError violation : exception.getAllErrors()) {
			errors.add(violation.getObjectName() + ": " + violation.getDefaultMessage());
		}
